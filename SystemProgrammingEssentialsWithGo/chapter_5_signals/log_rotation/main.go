...
const (
	logFilePath = "/home/klundert/SystemProgrammingEssentialswithGo/chapter_5_signals/log_rotation/example.log"
	maxFileSize = 400
)
...
func rotateLogFile() {
	...
	newLogFilePath := fmt.Sprintf("example_%s.log", timestamp)
